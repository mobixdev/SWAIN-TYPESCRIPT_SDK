...
var BaseAPI = /** @class */ (function () {
    ...
    BaseAPI.prototype.createFetchParams = function (context, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var url, headers, apiKey, accessToken, credentials, initOverrideFn, initParams, overriddenInit, _a, body, init;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!this.configuration.apiKey) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.configuration.apiKey('api_key')];
                    case 1:
                        apiKey = _b.sent();
                        if (apiKey) {
                            headers['X-API-KEY'] = apiKey; // Change header name if needed
                        }
                        _b.label = 2;
                    case 2:
                        if (!this.configuration.accessToken) return [3 /*break*/, 4];
                    ...
                    case 3:
                        ...
                        _b.label = 4;
                    case 4:
                        // Add basic auth to headers if username and password are present
                        if (this.configuration.username && this.configuration.password) {
                            credentials = btoa("".concat(this.configuration.username, ":").concat(this.configuration.password));
