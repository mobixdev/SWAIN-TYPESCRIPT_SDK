                ...
                switch (_a.label) {
                    case 0:
                        if (requestParameters['credentials'] == null) {
                            throw new runtime.RequiredError('credentials', 'Required parameter "credentials" was null or undefined when calling authLoginPost().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                body: (0, index_1.AuthLoginRequestToJSON)(requestParameters['credentials']),
                            }, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.AuthAuthResultFromJSON)(jsonValue); })];
                }
            });
        });
    };
